return {
  ...
  config = function()
    require('navigator').setup {
      ...
      lsp = { format_on_save = true, disable_lsp = 'all' },
      default_mapping = false,
      icons = { icons = false },
      keymaps = {
        { key = '<leader>gr', func = require('navigator.reference').async_ref, desc = 'Find References' },
        { key = ']r', func = require('navigator.treesitter').goto_next_usage, desc = 'Next Usage' },
        { key = '[r', func = require('navigator.treesitter').goto_previous_usage, desc = 'Previous Usage' },
      },
    }

    vim.keymap.set('n', '<leader>nr', require('navigator.reference').reference)
